...
def trans_continue() -> TransformerResult:
    """
...
def trans_stop() -> TransformerResult:
    """
...
def factory_trans_return(value) -> types.FunctionType:
    """
    A factory function that produces a transformer which returns
    TransformerResult.RETURN along with a given value.

    :param value: The value to return with the result
    """

    def inner() -> (TransformerResult, object):
