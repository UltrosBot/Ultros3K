...
from ultros.core.storage.data.json import JSONData
...
class TestJSON(TestCase):
    def setUp(self):
        ...
        shutil.copy(os.path.join(tests_dir, "files/test.json"), os.path.join(self.data_dir, "test.json"))
    ...
    def test_dict_functionality(self):
        """
        JSON data testing: Dict functionality
        """

        def _data_object() -> JSONData:
